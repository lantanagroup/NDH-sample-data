...
module PDEX
  class InsurancePlanFactory
    ...
    def id
      "ndh-#{resource_type}-#{source_data.id}"
    end
    ...
    def network
      [
        {
          reference: "Organization/ndh-network-#{source_data.network_id}",
    ...
    def owned_by
      {
        reference: "Organization/ndh-organization-#{source_data.owner_id}",
    ...
    def administered_by
      {
        reference: "Organization/ndh-organization-#{source_data.administrator_id}",
    ...
    #           network: [
    #             {
    #               reference: "Organization/ndh-organization-#{source_data.network_id}",
    #               display: source_data.network_name
    #             }
    #           ],
    #           benefit: [
