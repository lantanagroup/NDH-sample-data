...
module NDH
  class PractitionerRoleFactory
    ...
    def id
      "ndh-practitionerrole-#{source_data.npi}"
    end
      ...
      network_data.map do |network|
        {
          ...
          valueReference: {
            reference: "Organization/ndh-network-#{network.npi}",
    ...
    def practitioner
      {
        reference: "Practitioner/ndh-practitioner-#{source_data.npi}",
    ...
    def organization
      {
        reference: "Organization/ndh-organization-#{organization_data.npi}",
    ...
    def location
      [
        {
          reference: "Location/ndh-location-#{organization_data.npi}",
          display: organization_data.name
        }
      ]
    end
